...
function Challenge() {
    ...
    return (
        <div>
            ...
            <MapContainer style={{ width: "500px", height: "500px" }} center={userLocation ? [userLocation.latitude, userLocation.longitude] : [51.505, -0.09]} zoom={13} scrollWheelZoom={false}>
                <TileLayer
